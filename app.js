...
const STORE='b2-native-cards-extra-v30';
...
function getSpriteMeta(){return window.DARI_AUDIO_SPRITE||{sprites:['dari-sprite-1.mp3?v=30'],entries:{}}}
function spriteSrcFor(entry){const meta=getSpriteMeta();const list=meta.sprites||[];const n=Math.max(1,Number(entry&&entry.f)||1);return list[n-1]||list[0]||'dari-sprite-1.mp3?v=30'}
